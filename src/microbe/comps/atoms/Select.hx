...
class Select<T:{n:String,v:Array<{id:Int,value:String,inside:Bool}>}> extends Atom<T> implements Microbe<T> {
	...
	public function new(d:T,name:String,?classes:Array<String>,?size:Int,?multiple:Bool=true){
