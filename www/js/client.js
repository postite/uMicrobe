...
var erazor_Template = function(template) {
	...
	this.parsedBlocks = new erazor_Parser().parse(template);
	this.script = new erazor_ScriptBuilder("__b__").build(this.parsedBlocks);
	this.parser = new hscript_Parser();
	this.program = this.parser.parseString(this.script);
};
...
erazor_Template.prototype = {
	...
	,execute: function(content) {
		...
		if(__map_reserved["__string_buf__"] != null) {
			_this1.setReserved("__string_buf__",value);
		} else {
			_this1.h["__string_buf__"] = value;
		}
		...
		if(__map_reserved["__restore_buf__"] != null) {
			_this2.setReserved("__restore_buf__",value1);
		} else {
			_this2.h["__restore_buf__"] = value1;
		}
		interp.execute(this.program);
		return buffer.b;
	}
...
var erazor__$Parser_ParseContext = $hxEnums["erazor._Parser.ParseContext"] = { __ename__ : ["erazor","_Parser","ParseContext"], __constructs__ : ["literal","code"]
	,literal: {_hx_index:0,__enum__:"erazor._Parser.ParseContext",toString:$estr}
	,code: {_hx_index:1,__enum__:"erazor._Parser.ParseContext",toString:$estr}
};
var erazor__$Parser_ParseResult = $hxEnums["erazor._Parser.ParseResult"] = { __ename__ : ["erazor","_Parser","ParseResult"], __constructs__ : ["keepGoing","doneIncludeCurrent","doneSkipCurrent"]
	,keepGoing: {_hx_index:0,__enum__:"erazor._Parser.ParseResult",toString:$estr}
	,doneIncludeCurrent: {_hx_index:1,__enum__:"erazor._Parser.ParseResult",toString:$estr}
	,doneSkipCurrent: {_hx_index:2,__enum__:"erazor._Parser.ParseResult",toString:$estr}
};
...
erazor_Parser.prototype = {
	...
	,parseCodeBlock: function(template) {
		if(this.bracketStack.length > 0 && this.peek(template) == "}") {
			...
			if(_g == null ? true : _g._hx_index == 1 ? --this.conditionalStack < 0 : true) {
...
var erazor_TBlock = $hxEnums["erazor.TBlock"] = { __ename__ : ["erazor","TBlock"], __constructs__ : ["literal","codeBlock","printBlock"]
	,literal: ($_=function(s) { return {_hx_index:0,s:s,__enum__:"erazor.TBlock",toString:$estr}; },$_.__params__ = ["s"],$_)
	,codeBlock: ($_=function(s) { return {_hx_index:1,s:s,__enum__:"erazor.TBlock",toString:$estr}; },$_.__params__ = ["s"],$_)
	,printBlock: ($_=function(s) { return {_hx_index:2,s:s,__enum__:"erazor.TBlock",toString:$estr}; },$_.__params__ = ["s"],$_)
};
...
microbe_FormGenerator.instanciateComp = function(comp,data,name) {
	...
	var mic = null;
	try {
		mic = Type.createInstance($hxClasses[fullClassPath],[data,name]);
	} catch( msg ) {
...
ufront_api_UFApi.prototype = {
	...
	,_makeApiCall: function(method,args) {
		...
		try {
			...
			var flags = this1;
			isFuture = (flags & 1 << ufront_api_ApiReturnType.ARTFuture._hx_index) != 0;
		} catch( e ) {
			haxe_CallStack.lastException = e;
			var e1 = (e instanceof js__$Boot_HaxeError) ? e.val : e;
		}
...
ufront_api_UFAsyncApi.prototype = {
	...
	,_makeApiCall: function(method,args,flags,pos) {
		...
		cnx.call(args,function(result) {
			var wrappedOutcome;
			if((flags & 1 << ufront_api_ApiReturnType.ARTVoid._hx_index) != 0) {
				wrappedOutcome = tink_core_Outcome.Success(tink_core_Noise.Noise);
			} else if((flags & 1 << ufront_api_ApiReturnType.ARTOutcome._hx_index) != 0) {
				var outcome = result;
...
var microbe_comps_molecules_ErrorType = $hxEnums["microbe.comps.molecules.ErrorType"] = { __ename__ : ["microbe","comps","molecules","ErrorType"], __constructs__ : ["Info","UserError","SiteError"]
	,Info: {_hx_index:0,__enum__:"microbe.comps.molecules.ErrorType",toString:$estr}
	,UserError: {_hx_index:1,__enum__:"microbe.comps.molecules.ErrorType",toString:$estr}
	,SiteError: {_hx_index:2,__enum__:"microbe.comps.molecules.ErrorType",toString:$estr}
};
...
microbe_comps_molecules_Login.prototype = $extend(microbe_comps_Molecule.prototype,{
	render: function() {
		...
		var this2 = new tink_core_MPair("pass",this.data.b);
		var t2 = new microbe_comps_molecules_LabelPass(this2).render();
...
var microbe_comps_wrappers_Status = $hxEnums["microbe.comps.wrappers.Status"] = { __ename__ : ["microbe","comps","wrappers","Status"], __constructs__ : ["None","Render","Exec","Rec","Abort"]
	,None: {_hx_index:0,__enum__:"microbe.comps.wrappers.Status",toString:$estr}
	,Render: {_hx_index:1,__enum__:"microbe.comps.wrappers.Status",toString:$estr}
	,Exec: {_hx_index:2,__enum__:"microbe.comps.wrappers.Status",toString:$estr}
	,Rec: ($_=function(id) { return {_hx_index:3,id:id,__enum__:"microbe.comps.wrappers.Status",toString:$estr}; },$_.__params__ = ["id"],$_)
	,Abort: {_hx_index:4,__enum__:"microbe.comps.wrappers.Status",toString:$estr}
};
		...
		this.fdata.handle(function(t) {
			...
			microbial.recFromFormule(formule).handle(function(o) {
				...
				case 1:
					...
					switch(_g._hx_index) {
					case 0:
						var responseData = _g.responseData;
						var responseCode = _g.responseCode;
						var remotingCallString = _g.remotingCallString;
						console.log(remotingCallString + "-" + responseCode);
						break;
					case 6:
						var err = _g.data;
						var str = _g.remotingCallString;
						console.log(str);
...
ufront_web_Controller.prototype = {
	...
	,wrapResult: function(result,wrappingRequired) {
		if(result == null) {
			...
			var future = (wrappingRequired & 1 << ufront_web_result_ResultWrapRequired.WRFuture._hx_index) != 0 ? this.wrapInFuture(result) : result;
			var surprise = (wrappingRequired & 1 << ufront_web_result_ResultWrapRequired.WROutcome._hx_index) != 0 ? this.wrapInOutcome(future) : future;
			var finalResult = (wrappingRequired & 1 << ufront_web_result_ResultWrapRequired.WRResultOrError._hx_index) != 0 ? this.wrapResultOrError(surprise) : surprise;
			return finalResult;
		}
	}
	...
	,execute: function() {
		...
		try {
			if(0 == uriParts.length) {
				...
				var this2 = haxe_rtti_Meta.getFields(microbe_control_HomeController).execute_mic.wrapResult[0];
...
microbe_control_MicrobeCompileController.prototype = $extend(ufront_web_Controller.prototype,{
	...
	,init: function() {
		...
		var this2 = ufront_web_result_ViewResult.globalPartials;
		...
		var this3 = ufront_web_result_ViewResult.globalPartials;
		...
		var this4 = ufront_web_result_ViewResult.globalPartials;
	...
	,mods: function(name) {
		...
		var f = function(n) {
			...
			if(_gthis.context != null) {
				_gthis.context.messages.push({ msg : msg, pos : pos, type : ufront_log_MessageType.MLog});
			} else {
				haxe_Log.trace("Log: " + Std.string(msg),pos);
			}
		...
		var ret = tink_core__$Promise_Promise_$Impl_$.next(this.microbeApi.getAllModels(name),function(items) {
			var msg1 = "back" + Std.string(items) + name;
			...
			if(_gthis.context != null) {
				_gthis.context.messages.push({ msg : msg1, pos : pos1, type : ufront_log_MessageType.MLog});
			} else {
				haxe_Log.trace("Log: " + Std.string(msg1),pos1);
			}
			...
			var msg2 = "bock" + Std.string(items) + name;
			...
			if(_gthis.context != null) {
				_gthis.context.messages.push({ msg : msg2, pos : pos2, type : ufront_log_MessageType.MLog});
			} else {
				haxe_Log.trace("Log: " + Std.string(msg2),pos2);
			}
			var template = "<header><h1>Microbe Admin</h1>\n<a href=\"/::micPath::\" rel=\"pushstate\">⦿</a>\n</header>\n<div class=\"mic-walker\">\n\t<div class=\"mic-walk\" data-uf-partial=\"volist\">$$voList()</div>\n\t<div class=\"mic-walk\" data-uf-partial=\"items\">$$items()</div>\n\t<div class=\"mic-walk\" data-uf-partial=\"form\">$$form()</div>\n</div>";
			var obj = { };
			var this1 = obj != null ? obj : { };
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(microbe_views_ViewTools.wrapInLayout("mic",template,ufront_view__$TemplateData_TemplateData_$Impl_$.setObject(this1,{ mod : name, items : items})))));
		}).flatMap(function(o) {
			switch(o._hx_index) {
			case 0:
				var d = o.data;
		...
		var ret = tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(this.microbeApi.getFormuleFromString(mod),function(formule) {
			...
			if(Reflect.field(ufront_web_result_ViewResult.globalValues,"items") == null) {
				this1 = tink_core__$Promise_Promise_$Impl_$.next(api.getAllModels(mod),function(items) {
					ufront_view__$TemplateData_TemplateData_$Impl_$.set(ufront_web_result_ViewResult.globalValues,"items",items);
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(items)));
				});
			} else {
			...
			return tink_core__$Promise_Promise_$Impl_$.next(this1,function(items1) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(formule)));
			});
		}),function(formule1) {
			...
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(microbe_result__$MicrobeResult_MicrobeModelCompileResult_$Impl_$._new(mod,wrap,""))));
		}).flatMap(function(o) {
			switch(o._hx_index) {
			case 0:
				var d = o.data;
	...
	,update: function(mod,id) {
		...
		var ret = tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(this.microbeApi.getDataFormule(mod,id),function(formule) {
			...
			ufront_view__$TemplateData_TemplateData_$Impl_$.set(ufront_web_result_ViewResult.globalValues,"mod",mod);
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(microbe_result__$MicrobeResult_MicrobeModelCompileResult_$Impl_$._new(mod,new microbe_comps_wrappers_FormuleWrapper(formule1),""))));
		}).flatMap(function(o) {
			switch(o._hx_index) {
			case 0:
				var d = o.data;
	...
	,setup: function(mod) {
		var ret = tink_core__$Promise_Promise_$Impl_$.next(this.microbeApi.setupTable(mod),function(l) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(new ufront_web_result_ContentResult("ok table créée"))));
		}).flatMap(function(o) {
			switch(o._hx_index) {
			case 0:
				var d = o.data;
	...
	,execute: function() {
		...
		try {
			if(0 == uriParts.length) {
				...
				var this2 = haxe_rtti_Meta.getFields(microbe_control_MicrobeCompileController).mods.wrapResult[0];
				var wrappingRequired1 = this2;
				...
				this.context.actionContext.get_uriParts().splice(0,3);
				var this3 = haxe_rtti_Meta.getFields(microbe_control_MicrobeCompileController).plus.wrapResult[0];
				...
				var this4 = haxe_rtti_Meta.getFields(microbe_control_MicrobeCompileController).insert.wrapResult[0];
				...
				var this5 = haxe_rtti_Meta.getFields(microbe_control_MicrobeCompileController).update.wrapResult[0];
				...
				this.context.actionContext.get_uriParts().splice(0,2);
				var this6 = haxe_rtti_Meta.getFields(microbe_control_MicrobeCompileController).setup.wrapResult[0];
...
microbe_control_MicrobeController.prototype = $extend(ufront_web_Controller.prototype,{
	...
	,mods: function(name) {
		...
		var ret = tink_core__$Promise_Promise_$Impl_$.next(this.microbeApi.getAllModels(name),function(items) {
			...
			ufront_view__$TemplateData_TemplateData_$Impl_$.set(ufront_web_result_ViewResult.globalValues,"mod",name);
			var obj1 = { };
			var this2 = obj1 != null ? obj1 : { };
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(new ufront_web_result_PartialViewResult(ufront_view__$TemplateData_TemplateData_$Impl_$.setObject(this2,{ mod : name, items : items}),"index"))));
		}).flatMap(function(o) {
			switch(o._hx_index) {
			case 0:
				var d = o.data;
	...
	,insert: function(mod) {
		...
		var ret = tink_core__$Promise_Promise_$Impl_$.next(this.microbeApi.getFormuleFromString(mod),function(formule) {
			...
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(microbe_result__$MicrobeResult_MicrobeModelResult_$Impl_$._new(mod,new microbe_comps_wrappers_FormuleWrapper(formule),""))));
		}).flatMap(function(o) {
			switch(o._hx_index) {
			case 0:
				var d = o.data;
	...
	,execute: function() {
		...
		try {
			if(0 == uriParts.length) {
				...
				this.context.actionContext.args = [name];
				this.context.actionContext.get_uriParts().splice(0,3);
				var this2 = haxe_rtti_Meta.getFields(microbe_control_MicrobeController).mods.wrapResult[0];
				var wrappingRequired1 = this2;
				var result1 = this.wrapResult(this.mods(name),wrappingRequired1);
				this.setContextActionResultWhenFinished(result1);
				return result1;
				...
				this.context.actionContext.args = [name1];
				this.context.actionContext.get_uriParts().splice(0,3);
				var this3 = haxe_rtti_Meta.getFields(microbe_control_MicrobeController).plus.wrapResult[0];
				var wrappingRequired2 = this3;
				var result2 = this.wrapResult(this.plus(name1),wrappingRequired2);
				this.setContextActionResultWhenFinished(result2);
				return result2;
				...
				this.context.actionContext.args = [mod];
				this.context.actionContext.get_uriParts().splice(0,2);
				var this4 = haxe_rtti_Meta.getFields(microbe_control_MicrobeController).insert.wrapResult[0];
				var wrappingRequired3 = this4;
				var result3 = this.wrapResult(this.insert(mod),wrappingRequired3);
				this.setContextActionResultWhenFinished(result3);
				return result3;
				...
				this.context.actionContext.args = [mod1,id];
				this.context.actionContext.get_uriParts().splice(0,4);
				var this5 = haxe_rtti_Meta.getFields(microbe_control_MicrobeController).update.wrapResult[0];
				var wrappingRequired4 = this5;
				var result4 = this.wrapResult(this.update(mod1,id),wrappingRequired4);
				this.setContextActionResultWhenFinished(result4);
				return result4;
				...
				this.context.actionContext.args = [mod2];
				this.context.actionContext.get_uriParts().splice(0,2);
				var this6 = haxe_rtti_Meta.getFields(microbe_control_MicrobeController).setup.wrapResult[0];
				var wrappingRequired5 = this6;
				var result5 = this.wrapResult(this.setup(mod2),wrappingRequired5);
				this.setContextActionResultWhenFinished(result5);
				return result5;
...
ufront_web_result_ViewResult.addViewFolderToPath = function(layoutSource,viewFolder) {
	if(layoutSource._hx_index == 1) {
		var engine = layoutSource.templatingEngine;
		var path = layoutSource.path;
...
ufront_web_result_ViewResult.loadTemplateFromSource = function(source,engine) {
	...
	case 0:
		var templatingEngine = source.templatingEngine;
		var str = source.str;
		try {
		...
		break;
	case 1:
		var templatingEngine1 = source.templatingEngine;
...
ufront_web_result_ViewResult.executeTemplate = function(section,tplOutcome,combinedData,combinedHelpers) {
	switch(tplOutcome._hx_index) {
	case 0:
		var tpl = tplOutcome.data;
		try {
	...
	,renderResult: function(viewEngine,defaultData) {
		...
		return inlobj_map(function(viewTemplate,layoutTemplate,partialTemplates) {
			try {
				...
				if(layoutTemplate._hx_index == 0 && layoutTemplate.data == null) {
...
microbe_result__$MicrobeResult_MicrobeResult_$Impl_$._new = function(comp,formUrl,classes) {
	...
	var this3 = Type.getClassName(microbe_result_MicrobeAction);
	var this4 = ufront_web_result_AddClientActionResult.addClientAction(this2,this3,comp);
	return this4;
};
...
microbe_result__$MicrobeResult_MicrobeListResult_$Impl_$._new = function(data,wrapper,formUrl,classes) {
	...
	var this3 = Type.getClassName(microbe_result_MicrobeAction);
	var this4 = ufront_web_result_AddClientActionResult.addClientAction(this2,this3,wrapper);
	return this4;
};
...
microbe_result__$MicrobeResult_MicrobeModelResultList_$Impl_$._new = function(data,model,wrapper,formUrl,classes) {
	...
	var this2 = Type.getClassName(microbe_result_MicrobeListAction);
	var this3 = ufront_web_result_AddClientActionResult.addClientAction(this1,this2,wrapper);
	return this3;
};
...
microbe_result__$MicrobeResult_MicrobeModelResultOrderedList_$Impl_$._new = function(data,model,wrapper,formUrl,classes) {
	...
	var this2 = Type.getClassName(microbe_result_MicrobeListAction);
	var this3 = ufront_web_result_AddClientActionResult.addClientAction(this1,this2,listComp);
	return this3;
};
...
minject_InjectorMapping.prototype = {
	...
	,asSingleton: function() {
		var name = this.type;
		return this._toSingleton($hxClasses[name]);
	}
...
var ufront_api_ApiReturnType = $hxEnums["ufront.api.ApiReturnType"] = { __ename__ : ["ufront","api","ApiReturnType"], __constructs__ : ["ARTFuture","ARTOutcome","ARTVoid"]
	,ARTFuture: {_hx_index:0,__enum__:"ufront.api.ApiReturnType",toString:$estr}
	,ARTOutcome: {_hx_index:1,__enum__:"ufront.api.ApiReturnType",toString:$estr}
	,ARTVoid: {_hx_index:2,__enum__:"ufront.api.ApiReturnType",toString:$estr}
};
...
ufront_api_UFCallbackApi.getCallbackApi = function(syncApi) {
	...
	if(meta.callbackApi != null) {
		...
		if(asyncCallbackApiName != null) {
			return $hxClasses[asyncCallbackApiName];
		}
	}
	return null;
};
...
ufront_app_HttpApplication.prototype = {
	...
	,executeModules: function(modules,ctx,flag) {
		...
		runNext = function() {
			var m = modules.shift();
			if(flag != null && (ctx.completion & 1 << flag._hx_index) != 0) {
				done.trigger(tink_core_Outcome.Success(tink_core_Noise.Noise));
			} else if(m == null) {
				if(flag != null) {
					ctx.completion |= 1 << flag._hx_index;
				}
				done.trigger(tink_core_Outcome.Success(tink_core_Noise.Noise));
			} else {
				var moduleCb = m.a;
	...
	,handleError: function(err,ctx,doneTrigger) {
		var _gthis = this;
		if((ctx.completion & 1 << ufront_web_context_RequestCompletion.CErrorHandlersTriggered._hx_index) == 0) {
			ctx.completion |= 1 << ufront_web_context_RequestCompletion.CErrorHandlersTriggered._hx_index;
			...
			var allDone = tink_core__$Future_Future_$Impl_$._tryFailingFlatMap(tink_core__$Future_Future_$Impl_$._tryFailingFlatMap(this.executeModules(errHandlerModules,ctx,ufront_web_context_RequestCompletion.CErrorHandlersComplete),function(n) {
				ctx.completion |= 1 << ufront_web_context_RequestCompletion.CRequestHandlersComplete._hx_index;
				return ufront_core_SurpriseTools.success();
			}),function(n1) {
	...
	,flush: function(ctx) {
		if((ctx.completion & 1 << ufront_web_context_RequestCompletion.CFlushComplete._hx_index) == 0) {
			ctx.response.flush();
			ctx.completion |= 1 << ufront_web_context_RequestCompletion.CFlushComplete._hx_index;
		}
		return tink_core_Noise.Noise;
	}
...
ufront_app_DefaultUfrontController.prototype = $extend(ufront_web_Controller.prototype,{
	showMessage: function() {
		var msg = "Your Ufront App is almost ready.";
...
var ufront_auth_AuthError = $hxEnums["ufront.auth.AuthError"] = { __ename__ : ["ufront","auth","AuthError"], __constructs__ : ["ANotLoggedIn","ALoginFailed","ANotLoggedInAs","ANoPermission"]
	,ANotLoggedIn: {_hx_index:0,__enum__:"ufront.auth.AuthError",toString:$estr}
	,ALoginFailed: ($_=function(msg) { return {_hx_index:1,msg:msg,__enum__:"ufront.auth.AuthError",toString:$estr}; },$_.__params__ = ["msg"],$_)
	,ANotLoggedInAs: ($_=function(u) { return {_hx_index:2,u:u,__enum__:"ufront.auth.AuthError",toString:$estr}; },$_.__params__ = ["u"],$_)
	,ANoPermission: ($_=function(p) { return {_hx_index:3,p:p,__enum__:"ufront.auth.AuthError",toString:$estr}; },$_.__params__ = ["p"],$_)
};
...
var ufront_cache_CacheError = $hxEnums["ufront.cache.CacheError"] = { __ename__ : ["ufront","cache","CacheError"], __constructs__ : ["ENotInCache","EUnableToConnect","ECacheNotReadable","ECacheNotWriteable"]
	,ENotInCache: {_hx_index:0,__enum__:"ufront.cache.CacheError",toString:$estr}
	,EUnableToConnect: ($_=function(err) { return {_hx_index:1,err:err,__enum__:"ufront.cache.CacheError",toString:$estr}; },$_.__params__ = ["err"],$_)
	,ECacheNotReadable: ($_=function(err) { return {_hx_index:2,err:err,__enum__:"ufront.cache.CacheError",toString:$estr}; },$_.__params__ = ["err"],$_)
	,ECacheNotWriteable: ($_=function(err) { return {_hx_index:3,err:err,__enum__:"ufront.cache.CacheError",toString:$estr}; },$_.__params__ = ["err"],$_)
};
...
ufront_log_FileLogger.format = function(msg) {
	...
	var e = msg.type;
	var type = HxOverrides.substr($hxEnums[e.__enum__].__constructs__[e._hx_index],1,null);
	var pos = msg.pos;
...
ufront_log_FileLogger.prototype = {
	...
	,log: function(context,appMessages) {
		...
		return ufront_core_SurpriseTools.asBadSurprise(ufront_web_HttpError.notImplemented({ fileName : "ufront/log/FileLogger.hx", lineNumber : 92, className : "ufront.log.FileLogger", methodName : "log"}));
	}
	,__class__: ufront_log_FileLogger
};
var ufront_log_MessageType = $hxEnums["ufront.log.MessageType"] = { __ename__ : ["ufront","log","MessageType"], __constructs__ : ["MTrace","MLog","MWarning","MError"]
	,MTrace: {_hx_index:0,__enum__:"ufront.log.MessageType",toString:$estr}
	,MLog: {_hx_index:1,__enum__:"ufront.log.MessageType",toString:$estr}
	,MWarning: {_hx_index:2,__enum__:"ufront.log.MessageType",toString:$estr}
	,MError: {_hx_index:3,__enum__:"ufront.log.MessageType",toString:$estr}
};
...
var ufront_remoting_RemotingError = $hxEnums["ufront.remoting.RemotingError"] = { __ename__ : ["ufront","remoting","RemotingError"], __constructs__ : ["RHttpError","RApiNotFound","RServerSideException","RClientCallbackException","RUnserializeFailed","RNoRemotingResult","RApiFailure","RUnknownException"]
	,RHttpError: ($_=function(remotingCallString,responseCode,responseData) { return {_hx_index:0,remotingCallString:remotingCallString,responseCode:responseCode,responseData:responseData,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","responseCode","responseData"],$_)
	,RApiNotFound: ($_=function(remotingCallString,errorMessage) { return {_hx_index:1,remotingCallString:remotingCallString,errorMessage:errorMessage,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","errorMessage"],$_)
	,RServerSideException: ($_=function(remotingCallString,e,stack) { return {_hx_index:2,remotingCallString:remotingCallString,e:e,stack:stack,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","e","stack"],$_)
	,RClientCallbackException: ($_=function(remotingCallString,e) { return {_hx_index:3,remotingCallString:remotingCallString,e:e,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","e"],$_)
	,RUnserializeFailed: ($_=function(remotingCallString,troubleLine,err) { return {_hx_index:4,remotingCallString:remotingCallString,troubleLine:troubleLine,err:err,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","troubleLine","err"],$_)
	,RNoRemotingResult: ($_=function(remotingCallString,responseData) { return {_hx_index:5,remotingCallString:remotingCallString,responseData:responseData,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","responseData"],$_)
	,RApiFailure: ($_=function(remotingCallString,data) { return {_hx_index:6,remotingCallString:remotingCallString,data:data,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["remotingCallString","data"],$_)
	,RUnknownException: ($_=function(e) { return {_hx_index:7,e:e,__enum__:"ufront.remoting.RemotingError",toString:$estr}; },$_.__params__ = ["e"],$_)
};
...
ufront_remoting_RemotingHandler.prototype = {
	...
	,handleRequest: function(httpContext) {
		...
		if(__map_reserved[name] != null ? this1.existsReserved(name) : this1.h.hasOwnProperty(name)) {
			...
			remotingResponse.handle(function(response) {
				...
				r.clearContent();
				r.write(response);
				httpContext.completion |= 1 << ufront_web_context_RequestCompletion.CRequestHandlersComplete._hx_index;
	...
	,executeApiCall: function(path,args,remotingContext,actionContext) {
		...
		if((flags & 1 << ufront_api_ApiReturnType.ARTFuture._hx_index) != 0) {
			return result;
		} else if((flags & 1 << ufront_api_ApiReturnType.ARTVoid._hx_index) != 0) {
...
var ufront_remoting_RemotingDirection = $hxEnums["ufront.remoting.RemotingDirection"] = { __ename__ : ["ufront","remoting","RemotingDirection"], __constructs__ : ["RDClientToServer","RDServerToClient"]
	,RDClientToServer: {_hx_index:0,__enum__:"ufront.remoting.RemotingDirection",toString:$estr}
	,RDServerToClient: {_hx_index:1,__enum__:"ufront.remoting.RemotingDirection",toString:$estr}
};
		...
		while(_g < _g1.length) {
			...
			case "hxe":
				...
				try {
					...
					haxe_CallStack.lastException = e;
					ret1 = errors.push(ufront_remoting_RemotingError.RServerSideException(remotingCallString,(e instanceof js__$Boot_HaxeError) ? e.val : e,stack));
				}
				ret = ret1;
				break;
			case "hxr":
				...
				try {
					...
					haxe_CallStack.lastException = e1;
					ret2 = errors.push(ufront_remoting_RemotingError.RUnserializeFailed(remotingCallString,HxOverrides.substr(line,3,null),"" + Std.string((e1 instanceof js__$Boot_HaxeError) ? e1.val : e1)));
				}
				ret = ret2;
				hxrFound = true;
				break;
			case "hxs":
				...
				var stack1;
				try {
					stack1 = s2.unserialize();
				} catch( e2 ) {
					haxe_CallStack.lastException = e2;
					stack1 = errors.push(ufront_remoting_RemotingError.RUnserializeFailed(remotingCallString,HxOverrides.substr(line,3,null),"" + Std.string((e2 instanceof js__$Boot_HaxeError) ? e2.val : e2)));
				}
				stack = stack1;
				break;
			case "hxt":
				...
				var m1 = m;
				var extras = m1.pos != null && m1.pos.customParams != null ? " " + m1.pos.customParams.join(" ") : "";
				var msg = "[R]" + m1.pos.className + "." + m1.pos.methodName + "(" + m1.pos.lineNumber + "): " + Std.string(m1.msg) + extras;
...
ufront_remoting_RemotingUtil.defaultErrorHandler = function(error) {
	...
	case 0:
		var responseData = error.responseData;
		var responseCode = error.responseCode;
		var remotingCallString = error.remotingCallString;
		haxe_Log.trace("Error during remoting call " + remotingCallString + ": The HTTP Request returned status [" + responseCode + "].",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 126, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		haxe_Log.trace("Returned data: " + responseData,{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 127, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 1:
		var err = error.errorMessage;
		var remotingCallString1 = error.remotingCallString;
		haxe_Log.trace("Error during remoting call " + remotingCallString1 + ": API or Method is not found or not available in the remoting context.",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 129, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		haxe_Log.trace("Error message: " + err,{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 130, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 2:
		var stack = error.stack;
		var e = error.e;
		var remotingCallString2 = error.remotingCallString;
		haxe_Log.trace("Error during remoting call " + remotingCallString2 + ": The server threw an error \"" + Std.string(e) + "\".",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 132, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		haxe_Log.trace(stack,{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 133, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 3:
		var e1 = error.e;
		var remotingCallString3 = error.remotingCallString;
		haxe_Log.trace("Error during remoting call " + remotingCallString3 + ": The client throw an error \"" + Std.string(e1) + "\" during the remoting callback.",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 135, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		haxe_Log.trace("Compiling with \"-debug\" will prevent this error being caught, so you can use your browser's debugger to collect more information.",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 136, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 4:
		var err1 = error.err;
		var troubleLine = error.troubleLine;
		var remotingCallString4 = error.remotingCallString;
		haxe_Log.trace("Error during remoting call " + remotingCallString4 + ": Failed to unserialize this line in the response: \"" + err1 + "\"",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 138, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		haxe_Log.trace("The line that failed: \"" + err1 + "\"",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 139, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 5:
		var responseData1 = error.responseData;
		var remotingCallString5 = error.remotingCallString;
		haxe_Log.trace("Error during remoting call " + remotingCallString5 + ": No remoting result in data.",{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 141, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		haxe_Log.trace("Returned data: " + responseData1,{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 142, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 6:
		var data = error.data;
		var remotingCallString6 = error.remotingCallString;
		haxe_Log.trace("The remoting call " + remotingCallString6 + " functioned correctly, but the API returned a failure: " + data,{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 144, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	case 7:
		var e2 = error.e;
		haxe_Log.trace("Unknown error encountered during remoting call: " + Std.string(e2),{ fileName : "ufront/remoting/RemotingUtil.hx", lineNumber : 146, className : "ufront.remoting.RemotingUtil", methodName : "defaultErrorHandler"});
		break;
	}
};
	...
	,getTemplate: function(path,templatingEngine) {
		...
		if(templatingEngine != null && ext != "") {
			...
			this.getTemplateString(finalPath).handle(function(result) {
				switch(result._hx_index) {
				case 0:
					switch(result.data._hx_index) {
					case 0:
						var tpl = result.data.v;
			...
			testNextExtension = function() {
				if(exts.length > 0) {
					...
					_gthis.getTemplateString(finalPath).handle(function(result1) {
						...
						case 0:
							switch(result1.data._hx_index) {
							case 0:
								var tpl1 = result1.data.v;
				...
				if(tplEngines.length > 0) {
					...
					if(Lambda.has(engine.extensions,ext)) {
						...
						_gthis.getTemplateString(finalPath).handle(function(result2) {
							...
							case 0:
								switch(result2.data._hx_index) {
								case 0:
									var tpl2 = result2.data.v;
			...
			testNextEngineOrExtension = function() {
				...
				_gthis.getTemplateString(finalPath).handle(function(result3) {
					...
					case 0:
						switch(result3.data._hx_index) {
						case 0:
							var tpl3 = result3.data.v;
...
ufront_web_ErrorPageHandler.prototype = {
	...
	,handleError: function(httpError,ctx) {
		...
		if((ctx.completion & 1 << ufront_web_context_RequestCompletion.CRequestHandlersComplete._hx_index) == 0) {
			ctx.response.clear();
...
var ufront_web_context_RequestCompletion = $hxEnums["ufront.web.context.RequestCompletion"] = { __ename__ : ["ufront","web","context","RequestCompletion"], __constructs__ : ["CRequestMiddlewareComplete","CRequestHandlersComplete","CResponseMiddlewareComplete","CLogHandlersComplete","CFlushComplete","CErrorHandlersTriggered","CErrorHandlersComplete"]
	,CRequestMiddlewareComplete: {_hx_index:0,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
	,CRequestHandlersComplete: {_hx_index:1,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
	,CResponseMiddlewareComplete: {_hx_index:2,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
	,CLogHandlersComplete: {_hx_index:3,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
	,CFlushComplete: {_hx_index:4,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
	,CErrorHandlersTriggered: {_hx_index:5,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
	,CErrorHandlersComplete: {_hx_index:6,__enum__:"ufront.web.context.RequestCompletion",toString:$estr}
};
...
var ufront_web_result_ResultWrapRequired = $hxEnums["ufront.web.result.ResultWrapRequired"] = { __ename__ : ["ufront","web","result","ResultWrapRequired"], __constructs__ : ["WRFuture","WROutcome","WRResultOrError"]
	,WRFuture: {_hx_index:0,__enum__:"ufront.web.result.ResultWrapRequired",toString:$estr}
	,WROutcome: {_hx_index:1,__enum__:"ufront.web.result.ResultWrapRequired",toString:$estr}
	,WRResultOrError: {_hx_index:2,__enum__:"ufront.web.result.ResultWrapRequired",toString:$estr}
};
var ufront_web_result_TemplateSource = $hxEnums["ufront.web.result.TemplateSource"] = { __ename__ : ["ufront","web","result","TemplateSource"], __constructs__ : ["TFromString","TFromEngine","TNone","TUnknown"]
	,TFromString: ($_=function(str,templatingEngine) { return {_hx_index:0,str:str,templatingEngine:templatingEngine,__enum__:"ufront.web.result.TemplateSource",toString:$estr}; },$_.__params__ = ["str","templatingEngine"],$_)
	,TFromEngine: ($_=function(path,templatingEngine) { return {_hx_index:1,path:path,templatingEngine:templatingEngine,__enum__:"ufront.web.result.TemplateSource",toString:$estr}; },$_.__params__ = ["path","templatingEngine"],$_)
	,TNone: {_hx_index:2,__enum__:"ufront.web.result.TemplateSource",toString:$estr}
	,TUnknown: {_hx_index:3,__enum__:"ufront.web.result.TemplateSource",toString:$estr}
};
...
ufront_web_session_CacheSession.prototype = {
			...
			if(tmp) {
				...
				var ret = this.cache.get(this.sessionID).map(function(outcome) {
					...
					case 0:
						...
						break;
					case 1:
						switch(outcome.failure._hx_index) {
						case 0:
	...
	,findNewSessionID: function() {
		...
		var ret = this.cache.get(tryID).flatMap(function(outcome) {
			switch(outcome._hx_index) {
			case 0:
				var outcome1 = outcome.data;
				return _gthis.findNewSessionID();
			case 1:
				if(outcome.failure._hx_index == 0) {
					...
					var ret1 = _gthis1.set(tryID,this1).map(function(outcome2) {
						switch(outcome2._hx_index) {
						case 0:
							return tink_core_Outcome.Success(tryID);
						case 1:
							var err = outcome2.failure;
...
ufront_web_upload_BaseUpload.prototype = {
	...
	,hxSerialize: function(s) {
		...
		if(rs != null) {
			var _g = rs.direction;
			attachingUpload = _g._hx_index == 0;
		} else {
