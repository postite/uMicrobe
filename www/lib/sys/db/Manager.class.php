...
class sys_db_Manager {
	...
	public function dynamicSearch($x, $lock = null) {
		$GLOBALS['%s']->push("sys.db.Manager::dynamicSearch");
		$__hx__spos = $GLOBALS['%s']->length;
		$s = new StringBuf();
		$s->add("SELECT * FROM ");
		...
		{
			$tmp = $this->unsafeObjects($s->b, $lock);
			$GLOBALS['%s']->pop();
			return $tmp;
		}
		$GLOBALS['%s']->pop();
	...
	public function isBinary($t) {
		$GLOBALS['%s']->push("sys.db.Manager::isBinary");
		$__hx__spos = $GLOBALS['%s']->length;
		switch($t->index) {
		case 16:case 17:case 18:case 19:case 22:{
			$GLOBALS['%s']->pop();
	...
	public function hasBinaryChanged($a, $b) {
		$GLOBALS['%s']->push("sys.db.Manager::hasBinaryChanged");
		$__hx__spos = $GLOBALS['%s']->length;
		if($a !== $b) {
			$tmp = null;
			if($a !== null) {
	...
	public function unsafeCount($sql) {
		$GLOBALS['%s']->push("sys.db.Manager::unsafeCount");
		$__hx__spos = $GLOBALS['%s']->length;
		{
			$tmp = $this->unsafeExecute($sql)->getIntResult(0);
			$GLOBALS['%s']->pop();
			return $tmp;
		}
		$GLOBALS['%s']->pop();
	...
	public function unsafeGetId($o) {
		$GLOBALS['%s']->push("sys.db.Manager::unsafeGetId");
		$__hx__spos = $GLOBALS['%s']->length;
		if($o === null) {
			$GLOBALS['%s']->pop();
			return null;
		} else {
			$tmp = Reflect::field($o, $this->table_keys[0]);
			$GLOBALS['%s']->pop();
			return $tmp;
		}
		$GLOBALS['%s']->pop();
	...
	public function addCondition($s, $x) {
		$GLOBALS['%s']->push("sys.db.Manager::addCondition");
		$__hx__spos = $GLOBALS['%s']->length;
		$first = true;
		if($x !== null) {
			$_g = 0;
	...
	public function forceUpdate($o, $field) {
		$GLOBALS['%s']->push("sys.db.Manager::forceUpdate");
		$__hx__spos = $GLOBALS['%s']->length;
	...
	static function nullCompare($a, $b, $eq) {
		$GLOBALS['%s']->push("sys.db.Manager::nullCompare");
		$__hx__spos = $GLOBALS['%s']->length;
		$tmp = null;
		if($a !== null) {
			$tmp = $a === "NULL";
		...
		if($tmp) {
			if($eq) {
				$tmp2 = "" . _hx_string_or_null($b) . " IS NULL";
				$GLOBALS['%s']->pop();
				return $tmp2;
			} else {
				$tmp2 = "" . _hx_string_or_null($b) . " IS NOT NULL";
				$GLOBALS['%s']->pop();
				return $tmp2;
			}
		} else {
			...
			if($tmp1) {
				if($eq) {
					$tmp2 = "" . _hx_string_or_null($a) . " IS NULL";
					$GLOBALS['%s']->pop();
					return $tmp2;
				} else {
					$tmp2 = "" . _hx_string_or_null($a) . " IS NOT NULL";
					$GLOBALS['%s']->pop();
					return $tmp2;
				}
			}
		...
		if(sys_db_Manager::$cnx->dbName() !== "MySQL") {
			...
			{
				$tmp3 = _hx_string_or_null($a) . _hx_string_or_null($tmp2) . _hx_string_or_null($b);
				$GLOBALS['%s']->pop();
				return $tmp3;
			}
		}
	...
	static function quoteList($v, $it) {
		$GLOBALS['%s']->push("sys.db.Manager::quoteList");
		$__hx__spos = $GLOBALS['%s']->length;
		$b = new StringBuf();
		$first = true;
		if($it !== null) {
		...
		{
			$tmp = _hx_string_or_null($v) . " IN (" . _hx_string_or_null($b->b) . ")";
			$GLOBALS['%s']->pop();
			return $tmp;
		}
		$GLOBALS['%s']->pop();
