 ...
 * Haxe source file: /usr/local/lib/haxe/std/php/_std/sys/io/File.hx
 */
...
class File {
	...
	static public function append ($path, $binary = true) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:56: characters 3-66
		if ($binary === null) {
			#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:56: characters 3-66
			$binary = true;
		}
	...
	static public function copy ($srcPath, $dstPath) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:67: characters 3-32
	...
	static public function getBytes ($path) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:34: characters 10-57
	...
	static public function read ($path, $binary = true) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:48: characters 3-73
		if ($binary === null) {
			#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:48: characters 3-73
			$binary = true;
		}
	...
	static public function saveBytes ($path, $bytes) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:42: characters 3-23
		$f = File::write($path);
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:43: characters 3-17
		$f->write($bytes);
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:44: characters 3-12
		$f->close();
	}
	...
	static public function update ($path, $binary = true) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:59: lines 59-64
		if ($binary === null) {
			#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:59: lines 59-64
			$binary = true;
		}
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:60: lines 60-62
		if (!file_exists($path)) {
			#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:61: characters 4-23
			File::write($path)->close();
		}
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:63: characters 3-68
	...
	static public function write ($path, $binary = true) {
		#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:52: characters 3-66
		if ($binary === null) {
			#/usr/local/lib/haxe/std/php/_std/sys/io/File.hx:52: characters 3-66
			$binary = true;
		}
