	...
	public function execute() {
		...
		try {
			...
			$e = $_ex_;
			{
				...
				{
					$tmp2 = ufront_core_SurpriseTools::asSurpriseError($e, _hx_string_or_null($tmp) . _hx_string_or_null($this->context->actionContext->action) . "()", _hx_anonymous(array("fileName" => "UfrontConfiguration.hx", "lineNumber" => 276, "className" => "ufront.app.DefaultUfrontController", "methodName" => "execute")));
					$GLOBALS['%s']->pop();
					return $tmp2;
				}
			}
