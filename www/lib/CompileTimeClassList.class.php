...
CompileTimeClassList::$__meta__ = _hx_anonymous(array("obj" => _hx_anonymous(array("classLists" => (new _hx_array(array((new _hx_array(array("null,true,ufront.web.Controller", "microbe.control.HomeController,microbe.control.MicrobeController,ufront.app.DefaultUfrontController"))), (new _hx_array(array("null,true,ufront.api.UFApi", "microbe.apis.ImageBaseApi,microbe.apis.MicrobialApi,microbe.apis.UpApi,ufront.cache.DBCacheApi"))), (new _hx_array(array("null,true,ufront.web.Controller", "microbe.control.HomeController,microbe.control.MicrobeController,ufront.app.DefaultUfrontController"))), (new _hx_array(array("null,true,ufront.api.UFApi", "microbe.apis.ImageBaseApi,microbe.apis.MicrobialApi,microbe.apis.UpApi,ufront.cache.DBCacheApi"))), (new _hx_array(array("null,true,ufront.web.client.UFClientAction", "microbe.result.MicrobeAction,microbe.result.MicrobeListAction"))))))))));
