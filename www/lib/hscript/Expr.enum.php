...
class hscript_Expr extends Enum {
	...
	public static function EDoWhile($cond, $e) { return new hscript_Expr("EDoWhile", 24, array($cond, $e)); }
	...
	public static function EMeta($name, $args, $e) { return new hscript_Expr("EMeta", 25, array($name, $args, $e)); }
	...
	public static $__constructors = array(16 => 'EArray', 17 => 'EArrayDecl', 6 => 'EBinop', 4 => 'EBlock', 12 => 'EBreak', 8 => 'ECall', 0 => 'EConst', 13 => 'EContinue', 24 => 'EDoWhile', 5 => 'EField', 11 => 'EFor', 14 => 'EFunction', 1 => 'EIdent', 9 => 'EIf', 25 => 'EMeta', 18 => 'ENew', 21 => 'EObject', 3 => 'EParent', 15 => 'EReturn', 23 => 'ESwitch', 22 => 'ETernary', 19 => 'EThrow', 20 => 'ETry', 7 => 'EUnop', 2 => 'EVar', 10 => 'EWhile');
	}
