...
class hscript_Token extends Enum {
	...
	public static function TMeta($s) { return new hscript_Token("TMeta", 15, array($s)); }
	public static function TOp($s) { return new hscript_Token("TOp", 3, array($s)); }
	public static $TPClose;
	public static $TPOpen;
	public static function TPrepro($s) { return new hscript_Token("TPrepro", 16, array($s)); }
	public static $TQuestion;
	public static $TSemicolon;
	public static $__constructors = array(12 => 'TBkClose', 11 => 'TBkOpen', 7 => 'TBrClose', 6 => 'TBrOpen', 9 => 'TComma', 1 => 'TConst', 8 => 'TDot', 14 => 'TDoubleDot', 0 => 'TEof', 2 => 'TId', 15 => 'TMeta', 3 => 'TOp', 5 => 'TPClose', 4 => 'TPOpen', 16 => 'TPrepro', 13 => 'TQuestion', 10 => 'TSemicolon');
	}
