 ...
 * Haxe source file: /usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx
 */
...
class JsonPrinter {
	...
	public function ipad () {
		#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:72: characters 3-70
		if ($this->pretty) {
			#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:72: characters 15-70
			$v = \StringTools::lpad("", $this->indent, $this->nind * strlen($this->indent));
			#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:72: characters 15-70
			$this->buf->add($v);
		}
	}
	...
	public function newl () {
		#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:76: characters 3-33
		if ($this->pretty) {
			#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:76: characters 15-33
			$_this = $this->buf;
			#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:76: characters 15-33
			$_this->b = ($_this->b??'null') . (chr(10)??'null');
		}
	}
	...
	public function objString ($v) {
		#/usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:158: characters 3-36
